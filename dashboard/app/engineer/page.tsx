...
export default function EngineerPage() {
  ...
  const handleExport = () => {
    setExportSuccess(
      `Successfully compiled ${selectedModel} to ${exportFormat.toUpperCase()} format for ESP32/Raspberry Pi!`,
    );
        ...
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Deep evaluation, feature importance weights, confusion matrices,
              and microcontroller deployment.
            </p>
          </div>
            ...
            >
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M4 16v1a3 3 0 003 3h10a3 3 0 013-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"
                />
              </svg>
          ...
          <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Evaluation metrics on out-of-time validation splits (no data
                leakage).
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex w-full flex-wrap items-center gap-3 sm:w-auto">
              ...
              <select
                ...
                className="flex-1 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs font-semibold text-slate-800 dark:text-slate-100 shadow-sm sm:flex-none"
              >
              ...
              <button
                onClick={handleExport}
                className="flex-1 rounded-xl bg-slate-900 dark:bg-white px-4 py-1.5 text-xs font-bold text-white dark:text-slate-900 hover:opacity-90 transition-opacity sm:flex-none"
              >
                Compile Model
              </button>
            </div>
